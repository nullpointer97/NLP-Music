...
public class PlayButton: UIButton {
    ...
    @IBInspectable
    public var pauseStopBackgroundColor: UIColor? = .label {
        didSet {
            updateColors()
        }
    }
    ...
    @IBInspectable
    public var pauseStopTintColor: UIColor? = .systemBackground {
        didSet {
            updateColors()
        }
    }
    ...
    @IBInspectable
    public var playBufferingBackgroundColor: UIColor? = .label {
        didSet {
            updateColors()
        }
    }
    ...
    @IBInspectable
    public var playBufferingTintColor: UIColor? = .systemBackground {
        didSet {
            updateColors()
        }
    }
    ...
    @IBInspectable
    public var triangleCornerRadius: CGFloat = 2 {
        didSet {
    ...
    public convenience init() {
        self.init(frame: CGRect(x: 0, y: 0, width: 60.0, height: 60.0))
    }
    ...
    public func setMode(fromPlayerState state: AudioPlayerState, animated: Bool = true) {
        let shouldAnimate = UIApplication.shared.applicationState == .active && animated
        ...
        print("current state/mode:", state, mode)
    ...
    private let defaultBufferingDuration: CFTimeInterval = 1
    ...
    private var animationStepDuration: CFTimeInterval { 0.07 * bufferingDuration }
    ...
    private func commonInit() {
        ...
        backgroundCircle.cornerRadius = 30.0
