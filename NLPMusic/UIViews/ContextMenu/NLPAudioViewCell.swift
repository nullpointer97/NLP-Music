...
protocol MenuDelegate: AnyObject {
    func didOpenMenu(_ cell: NLPBaseViewCell<AudioPlayerItem>)
}
...
class NLPAudioViewCell: NLPBaseViewCell<AudioPlayerItem> {
    ...
    override func awakeFromNib() {
        ...
        downloadProgressView.tintColor = .getAccentColor(fromType: .common)
        ...
        let longPressGesture = UILongPressGestureRecognizer(target: self, action: #selector(didTapAudio))
