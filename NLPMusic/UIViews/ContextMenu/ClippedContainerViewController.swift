...
class ClippedContainerViewController: UIViewController {
    ...
    private let lightBlurEffect = UIBlurEffect(style: .extraLight)
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        blurEffectView.effect = traitCollection.userInterfaceStyle == .light ? lightBlurEffect : darkBlurEffect
        
        view.insertSubview(blurEffectView, at: 0)
        blurEffectView.autoPinEdge(.top, to: .top, of: view)
        blurEffectView.autoPinEdge(.bottom, to: .bottom, of: view)
        blurEffectView.autoPinEdge(.leading, to: .leading, of: view)
        blurEffectView.autoPinEdge(.trailing, to: .trailing, of: view)
        
        blurEffectView.drawBorder(12, width: 0)
