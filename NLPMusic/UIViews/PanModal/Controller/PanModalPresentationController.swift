...
//  PanModal
//
//  Copyright © 2020 Extended Team. All rights reserved.
//
...
open class PanModalPresentationController: UIPresentationController {
    ...
    struct Constants {
        ...
        static let dragIndicatorSize = CGSize(width: 35.0, height: 5.0)
    }
...
private extension PanModalPresentationController {
    ...
    func addDragIndicatorView(to view: UIView) {
        ...
        dragIndicatorView.topAnchor.constraint(equalTo: view.topAnchor, constant: presentable?.dragIndicatorOffset ?? 5).isActive = true
