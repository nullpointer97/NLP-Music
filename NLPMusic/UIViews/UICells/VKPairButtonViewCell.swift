...
@objc protocol PairButtonDelegate: AnyObject {
    @objc optional func didPlayAll(_ cell: VKPairButtonViewCell)
    @objc optional func didShuffleAll(_ cell: VKPairButtonViewCell)
}

@objc class VKPairButtonViewCell: UITableViewCell {
