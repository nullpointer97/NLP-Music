...
public class AdvancedActionSheet: UIViewController {
    ...
    private func postInit() {
        ...
        cancelView.backgroundColor = UIColor.asAlertBackground.withAlphaComponent(0.6)
        ...
        self.contentView.backgroundColor = UIColor.asAlertBackground.withAlphaComponent(0.6)
    }
    ...
    private func setupViews() {
        ...
        contentView.setBlurBackground(style: .regular, frame: contentView.frame, cornerRadius: 14)
        cancelView.setBlurBackground(style: .regular, frame: cancelView.frame, cornerRadius: 14)
    }
