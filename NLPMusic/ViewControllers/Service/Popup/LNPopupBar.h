...
/**
 * If @c true, the popup bar will automatically inherit its appearance from the bottom docking view.
 */
...
@property (nullable, nonatomic, copy, readwrite) UIColor* _titleColor;

@property (nullable, nonatomic, copy, readwrite) UIColor* _subtitleColor;
