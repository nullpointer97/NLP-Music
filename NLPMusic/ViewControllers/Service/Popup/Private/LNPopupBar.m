...
const CGFloat LNPopupBarHeightCompact = 36.0;
...
- (void)setSystemAppearance:(UIBarAppearance *)systemAppearance API_AVAILABLE(ios(13.0)) {
...
- (UIFont*)_titleFont
{
	return _resolvedStyle == LNPopupBarStyleProminent ? [UIFont systemFontOfSize:19 weight:UIFontWeightSemibold] : [UIFont systemFontOfSize:13 weight:UIFontWeightSemibold];
}
...
{
	return _resolvedStyle == LNPopupBarStyleProminent ? [UIFont systemFontOfSize:15 weight:UIFontWeightRegular] : [UIFont systemFontOfSize:12];
}
...
- (void)_layoutTitles
{
	...
	if(_needsLabelsLayout == YES)
	{
		if(_titleLabel == nil)
		{
            ...
            _titleLabel.textAlignment = _barStyle == LNPopupBarStyleCompact ? NSTextAlignmentCenter : NSTextAlignmentNatural;
		...
		if(_subtitleLabel == nil)
		{
            ...
            _subtitleLabel.textAlignment = _barStyle == LNPopupBarStyleCompact ? NSTextAlignmentCenter : NSTextAlignmentNatural;
...
- (void)pointerInteraction:(UIPointerInteraction *)interaction willEnterRegion:(UIPointerRegion *)region animator:(id<UIPointerInteractionAnimating>)animator  API_AVAILABLE(ios(13.4))
{
	...
	[animator addAnimations:^{
        if(self->_customBarViewController == nil || self->_customBarViewController.wantsDefaultHighlightGestureRecognizer == YES)
		{
...
- (void)setBackgroundStyle:(UIBlurEffectStyle)backgroundStyle
{
    ...
    if (@available(iOS 13.0, *)) {
        blurEffectStyle = backgroundStyle == LNBackgroundStyleInherit ? UIBlurEffectStyleSystemChromeMaterial : backgroundStyle;
    } else {
        blurEffectStyle = backgroundStyle == LNBackgroundStyleInherit ? UIBlurEffectStyleRegular : backgroundStyle;
    }
