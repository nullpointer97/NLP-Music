...
class NLPSettingsViewController: ASBaseViewController<ASTableNode> {
    ...
    func setupTableNode() {
        ...
        tableNode.view.separatorColor = .adaptableBorder.withAlphaComponent(0.1)
        tableNode.view.separatorInset.top = 0.5
    }
...
extension NLPSettingsViewController: ASTableDataSource, ASTableDelegate {
    ...
    func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        ...
        case 3:
            ...
            return "NLP Music \(versionNumber)-\(buildNumber)"
        default: return nil
        }
    }
}

extension NLPSettingsViewController: ASSettingActionDelegate {
    ...
    func didTap(_ node: ASSettingCellNode) {
        ...
        case .additionalText(let action):
            ...
            case .changeDismissType(_):
                ...
                openMenu(actions: [snapAction, interactiveAction])
            case .changePlayerStyle(_):
                ...
                openMenu(actions: [vkAction, appleAction])
            default: break
            }
        case .anotherView:
    ...
    private func changeDismissType(_ type: Int) {
        ...
        tableNode.reloadRows(at: [IndexPath(row: 2, section: 0)], with: .fade)
    }
}

extension NLPSettingsViewController: AudioItemActionDelegate {
...
extension NLPSettingsViewController: HSBColorPickerDelegate, ColorPickerDelegate {
