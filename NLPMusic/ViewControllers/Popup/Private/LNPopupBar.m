...
- (UIFont*)_titleFont
{
	return _resolvedStyle == LNPopupBarStyleProminent ? [UIFont systemFontOfSize:19 weight:UIFontWeightSemibold] : [UIFont systemFontOfSize:15 weight:UIFontWeightSemibold];
}
