...
class ColorPickerViewController: VKBaseViewController, ControlDelegate, PanModalPresentable {
    @IBOutlet weak var mainTable: InsetGroupedTableView!
    ...
    var dragIndicatorOffset: CGFloat {
        return 8
    }
