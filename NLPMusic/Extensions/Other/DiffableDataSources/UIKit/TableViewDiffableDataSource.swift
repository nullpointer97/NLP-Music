...
open class TableViewDiffableDataSource<SectionIdentifierType: Hashable, ItemIdentifierType: Hashable>: NSObject, UITableViewDataSource {
    ...
    public init(tableView: UITableView, headers: [String?] = [], footers: [String?] = [], cellProvider: @escaping CellProvider) {
    ...
    public func apply(_ snapshot: DiffableDataSourceSnapshot<SectionIdentifierType, ItemIdentifierType>, animatingDifferences: Bool = true, completion: (() -> Void)? = nil) {
        core.apply(snapshot, view: tableView, animatingDifferences: animatingDifferences, performUpdates: { tableView, changeset, setSections in
    ...
    open func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        return headers.indices.contains(section) ? headers[section] : nil
    }
    ...
    open func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        return footers.indices.contains(section) ? footers[section] : nil
    }
