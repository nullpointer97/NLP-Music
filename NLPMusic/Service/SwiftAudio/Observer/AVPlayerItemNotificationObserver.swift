...
protocol NLPAVPlayerItemNotificationObserverDelegate: AnyObject {
 ...
 */
class NLPAVPlayerItemNotificationObserver {
    
    private let notificationCenter: NotificationCenter = NotificationCenter.default
    
    private(set) weak var observingItem: AVPlayerItem?
    weak var delegate: NLPAVPlayerItemNotificationObserverDelegate?
