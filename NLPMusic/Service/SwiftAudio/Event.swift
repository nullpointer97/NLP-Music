...
extension NLPAudioPlayer {
    
    public typealias StateChangeEventData = (NLPAudioPlayerState)
    ...
    public struct EventHolder {
         ...
         */
        public let stateChange: NLPAudioPlayer.Event<StateChangeEventData> = NLPAudioPlayer.Event()
        
        /**
         Emitted when the playback of the player, for some reason, has stopped.
         - Important: Remember to dispatch to the main queue if any UI is updated in the event handler.
         */
        public let playbackEnd: NLPAudioPlayer.Event<PlaybackEndEventData> = NLPAudioPlayer.Event()
        
        /**
         Emitted when a second is elapsed in the `AudioPlayer`.
         - Important: Remember to dispatch to the main queue if any UI is updated in the event handler.
         */
        public let secondElapse: NLPAudioPlayer.Event<SecondElapseEventData> = NLPAudioPlayer.Event()
        ...
        /**
         ...
         - Important: Remember to dispatch to the main queue if any UI is updated in the event handler.
         */
        public let fail: NLPAudioPlayer.Event<FailEventData> = NLPAudioPlayer.Event()
        
        /**
         Emitted when the player is done attempting to seek.
         - Important: Remember to dispatch to the main queue if any UI is updated in the event handler.
         */
        public let seek: NLPAudioPlayer.Event<SeekEventData> = NLPAudioPlayer.Event()
        
        /**
         Emitted when the player updates its duration.
         - Important: Remember to dispatch to the main queue if any UI is updated in the event handler.
         */
        public let updateDuration: NLPAudioPlayer.Event<UpdateDurationEventData> = NLPAudioPlayer.Event()
         ...
         */
        public let didRecreateAVPlayer: NLPAudioPlayer.Event<()> = NLPAudioPlayer.Event()
