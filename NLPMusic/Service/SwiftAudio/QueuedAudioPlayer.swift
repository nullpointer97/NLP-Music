 ...
 */
public class QueuedAudioPlayer: NLPAudioPlayer {
    
    let queueManager: QueueManager = QueueManager<NLPAudioItem>()
    ...
    public override var currentItem: NLPAudioItem? {
     ...
     */
    public var previousItems: [NLPAudioItem] {
     ...
     */
    public var nextItems: [NLPAudioItem] {
     ...
     */
    public override func load(item: NLPAudioItem, playWhenReady: Bool) throws {
    ...
    /**
     ...
     - throws: `APError`
     */
    public func add(item: NLPAudioItem, playWhenReady: Bool = true) throws {
        if currentItem == nil {
    ...
    /**
     ...
     - throws: `APError`
     */
    public func add(items: [NLPAudioItem], playWhenReady: Bool = true) throws {
        if currentItem == nil {
...
//            try self.load(item: currentItem!, playWhenReady: playWhenReady)
    ...
    public func insert(items: [NLPAudioItem], toIndex index: Int = 0) throws {
        if currentItem == nil {
            try queueManager.insertItems(items, at: index)
//            try self.load(item: currentItem!, playWhenReady: false)
    ...
    public func add(items: [NLPAudioItem], at index: Int) throws {
