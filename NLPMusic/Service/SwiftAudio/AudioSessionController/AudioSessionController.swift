...
public protocol NLPAudioSessionControllerDelegate: AnyObject {
 ...
 */
public class NLPAudioSessionController {
    
    public static let shared = NLPAudioSessionController()
    
    private let audioSession: NLPAudioSession
    ...
    public weak var delegate: NLPAudioSessionControllerDelegate?
    
    init(audioSession: NLPAudioSession = AVAudioSession.sharedInstance()) {
