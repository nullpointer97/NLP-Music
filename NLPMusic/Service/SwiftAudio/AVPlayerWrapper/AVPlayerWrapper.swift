...
class NLPAVPlayerWrapper: NLPAVPlayerWrapperProtocol {
    ...
    let playerObserver: NLPAVPlayerObserver
    let playerTimeObserver: NLPAVPlayerTimeObserver
    let playerItemNotificationObserver: NLPAVPlayerItemNotificationObserver
    let playerItemObserver: NLPAVPlayerItemObserver
    ...
    fileprivate var _state: NLPAVPlayerWrapperState = NLPAVPlayerWrapperState.idle {
        didSet {
            if oldValue != _state {
    ...
    public init() {
        ...
        self.playerObserver = NLPAVPlayerObserver()
        self.playerObserver.player = avPlayer
        self.playerTimeObserver = NLPAVPlayerTimeObserver(periodicObserverTimeInterval: timeEventFrequency.getTime())
        self.playerTimeObserver.player = avPlayer
        self.playerItemNotificationObserver = NLPAVPlayerItemNotificationObserver()
        self.playerItemObserver = NLPAVPlayerItemObserver()
    ...
    var state: NLPAVPlayerWrapperState {
        return _state
    }
    ...
    weak var delegate: NLPAVPlayerWrapperDelegate? = nil
...
extension NLPAVPlayerWrapper: NLPAVPlayerObserverDelegate {
...
extension NLPAVPlayerWrapper: NLPAVPlayerTimeObserverDelegate {
...
extension NLPAVPlayerWrapper: NLPAVPlayerItemNotificationObserverDelegate {
...
extension NLPAVPlayerWrapper: NLPAVPlayerItemObserverDelegate {
