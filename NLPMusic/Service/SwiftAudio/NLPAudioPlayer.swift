...
public typealias NLPAudioPlayerState = NLPAVPlayerWrapperState

public class NLPAudioPlayer: NLPAVPlayerWrapperDelegate {
    
    private var _wrapper: NLPAVPlayerWrapperProtocol
    
    /// The wrapper around the underlying AVPlayer
    var wrapper: NLPAVPlayerWrapperProtocol {
        return _wrapper
    }
    ...
    var _currentItem: NLPAudioItem?
    public var currentItem: NLPAudioItem? {
        return _currentItem
    }
     ...
     */
    public var playerState: NLPAudioPlayerState {
    ...
    public init(nowPlayingInfoController: NowPlayingInfoControllerProtocol = NowPlayingInfoController(),
        ...
        self._wrapper = NLPAVPlayerWrapper()
     ...
     */
    public func load(item: NLPAudioItem, playWhenReady: Bool = true) throws {
        let url: URL
    ...
    func enableRemoteCommands(forItem item: NLPAudioItem) {
    ...
    private func loadArtwork(forItem item: NLPAudioItem) {
